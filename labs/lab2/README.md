...
1. Create a directory named after your username in your group HDFS directory. E.g. `/education/dsti_2021_fall_bda/$USER`
...
1. Look at the content of the input directory we will use: `/education/dsti_2021_fall_bda/resources/lab2`
2. Run the command:
   ```sh
   yarn jar /usr/hdp/current/hadoop-mapreduce-client/hadoop-mapreduce-examples-3.1.1.3.1.0.0-78.jar \
    wordcount /education/dsti_2021_fall_bda/resources/lab2 \
    /education/dsti_2021_fall_bda/$USER/lab2/output-moby-dick
   ```
